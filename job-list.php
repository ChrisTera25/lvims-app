...
if (isset($_GET['country']) && ($_GET['category'])) {
	...
	$slc_country = "NULL";
	$slc_category = "NULL";
	$title = "INTERNSHIP PROGRAMS AVAILABLE";
}
?>
<!-- ------------------------------------------ CDN IMPORTS --------------------------------------------- -->
<head>
	...
	<title>LVIMS <?php echo "$title"; ?></title>
	<meta name="description" content="LA VERDAD INTERNSHIP MANAGEMENT SYSTEMS" />
	...
	<meta property="og:description" content="LA VERDAD INTERNSHIP MANAGEMENT SYSTEMS" />
		...
		<header id="header">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow pt-lg-5">
			...
			<div class="second-search-result-wrapper">
				...
				<div class="container">
					...
					<form action="job-list.php" method="GET" autocomplete="off">
						...
						<div class="second-search-result-inner" style="margin-top: 20px;">
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>LVIMS is a internship management system, online intern management system developed by Aljon Isip for their Capstone Project in 2021 to 2022.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="./">Home</a></li>
											<li><a href="job-list.php">Internship Program</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Phone : <a href="(045) 436 1487">(045) 436 1487</a></p>
