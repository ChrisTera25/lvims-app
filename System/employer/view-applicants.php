...
<head>
	...
	<meta property="og:description" content="Online Internship Management System/ Internship Portal" />
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="./">Home</a></li>
						<li><span>Applicants for the internship program <?php echo "$job_title"; ?></< /span>
						</li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Applicants for the internship program <?php echo "$job_title"; ?></< /h3>
						</div>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="./">Home</a></li>
											<li><a href="job-list.php">Intership Programs</a></li>
