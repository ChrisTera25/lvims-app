...
<head>
	...
	<meta name="description" content="Online Internship Management System / Internship Portal" />
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="../employers.php">Industry Partner</a>
							</li>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Post an Internship</span></li>
					</ol>
									...
									<form class="post-form-wrapper" action="app/post-job.php" method="POST" autocomplete="off">
										...
										<div class="row gap-20">
											...
											<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
												...
												<div class="form-group mb-20">
													...
													<select name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
														<option value="" selected>Select</option>
														<option value="Expert">No Experience</option>
											...
											<div class="col-sm-6 mt-30">
												<button type="submit" onclick="validate(this)" class="btn btn-primary btn-lg">Post Your Internship</button>
											</div>
