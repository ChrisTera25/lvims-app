											...
											<ul class="pager-list">
												...
												if ($records > 1) {
													...
													if ($page == "1") {
														...
														print 'href="referees.php?page=' . $prevpage . '"';
													}
												...
												?><li class="paging-nav"><a <?php if ($b == $page) {
																				print ' style="background-color:#33B6CB; color:white" ';
																			} ?> href="referees.php?page=<?php echo "$b"; ?>"><?php echo $b . " "; ?></a></li><?php
																																							}
																																							print '<li class="paging-nav"';
																																							if ($page == $records) {
																																								print 'class="disabled"';
																																							...
																																							if ($page == $records) {
																																								...
																																								print 'href="referees.php?page=' . $nextpage . '"';
																																							}
									...
									<div class="row">
										...
										<div class="col-sm-6 col-md-4">
											...
											<div class="footer-about-us">
												...
												<p>LVIMS is a internship portal, online internship management system developed by the group of Aljon Isip in 2021 to 2022.</p>
