...
<head>
	...
	<title>LVIMS <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
	...
	<meta property="og:description" content="Online Internship Management / Job Portal" />
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="employees.php">All Interns</a></li>
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-5 mt-30-xs">
									...
									<ul class="footer-menu clearfix">
										...
										<li><a href="employers.php">Industry Partner</a></li>
