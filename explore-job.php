		...
		if ($rec == "0") {
			...
			foreach ($result as $row) {
				...
				if ($jobtype == "Internship") {
					$sta = '<span class="label label-success">Intern</span>';
				}
			}
		}
...
<head>
	...
	<title>LVIMS<?php echo "$jobtitle"; ?></title>
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-content mt-30 clearfix">
									...
									<h3>Intern's Responsibilities</h3>
										...
										if ($jobexpired == true) {
											...
											if ($myrole == "employee") {
												print '<button'; ?> onclick="update(this.value)" <?php print ' value="' . $jobid . '" class="btn btn-primary btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-pencil"></i> Apply this job</button>';
																									...
																									print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login as intern to apply</button>';
																								}
																							}
																						} else {

																							print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login to apply this program</button>';
																						}
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>LVIMS is an internship portal, online internship management system developed by the group of Aljon Isip for their capstone project in 2021 to 2022.</p>
